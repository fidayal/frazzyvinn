...
const messages = [
    ...
    "do you wanna know?",
    "seriously, do you wanna know? 🤔",
    "I know you are curious",
    "ok try to tap it, then 😏",
    "tap it, please",
    "tap it, tap it, tap it",
    "tap it, tap it, tap it, tap it",
    "try again",
    "again, vinnn!",
    "come on, keep tapping it",
    "you are so close",
    ...
    "the",
    "last one",
    "tapi boong, HAHAHAHAHAHAH GOTCHA",
    "you are so persistent",
    "I know that u are upset, now",
    "hmmm",
    "yaudah deh",
    "whereas",
    "i just wanna say",
    "ikan hiu main bareng kevin",
    "i love you, vin❤️",
    "cringe, lols",
    "and i want u to know that..",
    "i think i fell in love from the first time we talked",
    "My heart becomes filled with so much love that i cant breathe",
    "i wish we are not just friends",
    "i wish i can call u 'YAM'",
    "'You Are Mine'",
    "or 'MAK'",
    "'Mahal Akin Kalang'",
    "whatever it is", 
    "i can't call u with those names~",
    "yet",
    "So, would u like click the botton bellow for me?💝"
];
